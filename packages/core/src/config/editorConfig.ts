...
export function createEditor(
  ...
  config.features.forEach((feature, index) => {
    ...
    if (feature === 'fontFamily') {
      ...
      // Create Microsoft Word-style icon with underline
      button.innerHTML =
      ...
      resetButton.onmouseenter = () =>
        (resetButton.style.backgroundColor = '#e8e8e8');
      ...
      // Create Microsoft Word-style highlighter icon with underline indicator
      button.innerHTML =
