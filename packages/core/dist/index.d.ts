...
declare class LinkPopupView {
    private popup;
    private linkElement;
    private onOpenClick?;
    private onUnlinkClick?;
    constructor();
    setCallbacks(onOpenClick: (url: string) => void, onUnlinkClick: (linkElement: HTMLAnchorElement) => void): void;
    private createPopup;
    private createButton;
    private handleOpenClick;
    private handleUnlinkClick;
...
declare class SpeechToTextHandler {
    private document;
    private editorView;
    private recognition;
    private isRecording;
    ...
    private insertText;
    constructor(document: TextDocument, editorView: EditorView, onStateChange: (isRecording: boolean) => void, insertText: (text: string) => void);
