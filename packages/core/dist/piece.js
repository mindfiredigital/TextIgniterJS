class Piece {
    ...
    isBold() { return this.attributes.bold; }
    setBold(v) { this.attributes.bold = v; }
    isItalic() { return this.attributes.italic; }
    isUndo() { return this.attributes.undo; }
    isRedo() { return this.attributes.redo; }
    setItalic(v) { this.attributes.italic = v; }
    isUnderline() { return this.attributes.underline; }
    setUnderline(v) { this.attributes.underline = v; }
    setUndo(v) { this.attributes.undo = v; }
    setRedo(v) { this.attributes.redo = v; }
    clone() {
