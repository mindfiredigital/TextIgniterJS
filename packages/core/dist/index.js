...
class n extends t {
  ...
  deleteRange(t, n, i = '', s = 0) {
    ...
    let o = [],
      ...
      r = !1;
    ('' === i && null === i) ||
      ((a = this.blocks.findIndex(t => t.dataId === i)), (l = s));
    let d = 0;
    if (t === l) {
      d = a - 1 >= 0 && 'image' === this.blocks[a - 1].type ? a - 2 : a - 1;
      for (let t of this.blocks[d].pieces) o.push(t.clone()), (r = !0);
    }
    for (let i of this.blocks[a].pieces) {
      const s = l + i.text.length;
      if (s <= t || l >= n) o.push(i.clone());
      else {
        const a = l,
          r = i.text;
        t > a &&
          t < s &&
          o.push(new e(r.slice(0, t - a), Object.assign({}, i.attributes))),
          n < s &&
            o.push(new e(r.slice(n - a), Object.assign({}, i.attributes)));
      }
      l = s;
    }
    const c = this.mergePieces(o);
    r
  ...
  handleKeydown(t) {
    ...
    if ('Enter' === t.key) {
      ...
      const i = `data-id-${Date.now()}`,
        o = this.document.blocks.findIndex(
          t => t.dataId === this.document.selectedBlockId
        ),
        l = this.document.blocks[o];
      if (l && 'image' === l.type)
        this.document.blocks.splice(o + 1, 0, {
          dataId: i,
          class: 'paragraph-block',
          pieces: [new e(' ')],
          type: 'text',
        ...
        if (null !== this.getCurrentCursorBlock()) {
          const { remainingText: t, piece: o } = this.extractTextFromDataId(
          ...
          if (l.length > 0) {
            ...
            '' !== r[0] || void 0 !== r[1]
              ? 1 === o.length
                ? (d = [new e(l, o[0].attributes)])
                : (d.push(new e(' ' + r[0] + ' ', o[0].attributes)),
                  o.length >= 2 &&
                    o.forEach((t, e) => {
                      0 !== e && d.push(t);
                    }))
        ...
        if (
          ...
          this.document.blocks.splice(o + 1, 0, t),
          'ol' === l.listType || 'li' === l.listType)
        )
          for (let t = o + 2; t < this.document.blocks.length; t++) {
      ...
      if (
        ...
        this.document.deleteRange(
          ...
          this.document.blocks.findIndex(
            t => t.dataId === this.document.selectedBlockId
          );
        if (
          null ===
