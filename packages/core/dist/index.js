  ...
  constructor(t, e = {}) {
    ...
    n && (s = n.value),
      ...
      (this.attributes = {
        ...
        undo: e.undo || !1,
        redo: e.redo || !1,
        fontFamily: e.fontFamily || s,
        fontSize: e.fontSize || o,
...
class n extends t {
  ...
  insertAt(t, n, i, s = '', o = 0, l = '', a = '', r = !1) {
    ...
    let d = 0,
      ...
      u = 0;
    s &&
      ((u = this.blocks.findIndex(t => t.dataId === s)),
      (d = this.currentOffset));
    for (let s of this.blocks[u].pieces) {
      const o = d + s.text.length;
      if (!h && i <= o) {
        const o = i - d;
        o > 0 &&
          c.push(new e(s.text.slice(0, o), Object.assign({}, s.attributes))),
          c.push(
            new e(t, {
              bold: n.bold || !1,
              italic: n.italic || !1,
          ...
          o < s.text.length &&
            c.push(new e(s.text.slice(o), Object.assign({}, s.attributes))),
          (h = !0);
      } else c.push(s.clone());
      d = o;
    }
  ...
  deleteRange(t, n, i = '', s = 0, o = !1) {
    ...
    let l = [],
      ...
      d = !1;
    ('' === i && null === i) ||
      ((r = this.blocks.findIndex(t => t.dataId === i)), (a = s));
    let c = 0;
    if (o && t === a) {
      c = r - 1 >= 0 && 'image' === this.blocks[r - 1].type ? r - 2 : r - 1;
      for (let t of this.blocks[c].pieces) l.push(t.clone()), (d = !0);
    }
    for (let i of this.blocks[r].pieces) {
      const s = a + i.text.length;
      if (s <= t || a >= n) l.push(i.clone());
      else {
        const o = a,
          r = i.text;
        t > o &&
          t < s &&
          l.push(new e(r.slice(0, t - o), Object.assign({}, i.attributes))),
          n < s &&
            l.push(new e(r.slice(n - o), Object.assign({}, i.attributes)));
      }
      a = s;
    }
    let h = this.mergePieces(l);
    d
      ? ((this.blocks[c].pieces = h),
        (this.blocks[r].pieces = [new e(' ')]),
        (this.blocks = this.blocks.filter((t, e) => {
          if (e !== r) return t;
        })))
      : (0 === h.length && (h = [new e(' ')]), (this.blocks[r].pieces = h)),
      0 === h.length &&
  ...
  getAllSelectedDataIds() {
    ...
    let o;
    for (; (o = s.nextNode()); )
      if (n.intersectsNode(o)) {
        const e = o.nodeType === Node.TEXT_NODE ? o.parentElement : o,
          n =
  ...
  getSelectedDataIds() {
    ...
    const e = t.getRangeAt(0),
      ...
      i = e.startContainer,
      s = e.endContainer,
      o = this.getDataIdFromNode(i),
      l = this.getDataIdFromNode(s);
    return (
  ...
  getCursorOffset(t) {
    ...
    const s = t => {
      ...
      for (const e of Array.from(t.childNodes)) if (s(e)) return !0;
      return !1;
    };
    return s(t), i;
  }
  formatAttribute(t, n, i, s) {
    console.log('formatAttribute', t, n, i, s);
    let o = [],
      l = 0,
      a = -1;
    ...
    for (let r of this.blocks[a].pieces) {
      ...
      if (a <= t || l >= n) o.push(r.clone());
      else {
        const a = l,
          d = r.text,
          c = Math.max(t - a, 0),
          h = Math.min(n - a, d.length);
        c > 0 && o.push(new e(d.slice(0, c), Object.assign({}, r.attributes)));
        ...
        ((('bold' !== i &&
          ...
          o.push(u),
          h < d.length &&
            o.push(new e(d.slice(h), Object.assign({}, r.attributes)));
      }
      l = a;
    }
    const r = this.mergePieces(o);
      ...
      for (; (a = l.pop()); )
        if (3 === a.nodeType) {
          const e = a,
            n = o + e.length;
          if (t >= o && t <= n) {
            s.setStart(e, Math.min(t - o, e.length)), s.collapse(!0);
            break;
          }
          o = n;
        } else if ('BR' === a.tagName) {
          if (t === o) {
            s.setStartBefore(a), s.collapse(!0);
            break;
          }
          o++;
        } else {
  ...
  isRangeEntirelyAttribute(t, e, n) {
    ...
    if ('' !== this.selectedBlockId) {
      const o = this.blocks.findIndex(t => t.dataId === this.selectedBlockId);
      for (let l of this.blocks[o].pieces) {
        const o = i + l.text.length;
        if (o > t && i < e && !l.attributes[n]) {
          s = !1;
          break;
        }
        i = o;
  ...
  findPieceAtOffset(t, e = '') {
    ...
    if (e)
      for (let i of this.blocks) {
        const s = i.pieces.reduce((t, e) => t + e.text.length, 0);
        if (i.dataId == e) {
          let e = null;
          for (let s of i.pieces) {
            const i = n,
              o = i + s.text.length;
            if (t >= i && t < o) return t === i && e ? e : s;
            (e = s), (n = o);
          }
        } else n += s;
      }
  ...
  getCursorOffsetInParent(t) {
    ...
    if (!n.contains(s.startContainer)) return null;
    let o = 0,
      l = null;
    ...
    for (; a.nextNode(); ) {
      ...
      if (
        ...
        (o += s.startOffset), (l = t), (r = t.parentElement);
        break;
      }
      o +=
...
function i(t) {
  ...
  return { start: s, end: i.toString().length };
}
function s(t, e) {
  if (!e) return;
  let n = 0;
  ...
  for (; !a && (o = s.pop()); )
    if (3 === o.nodeType) {
      ...
      !l &&
        ...
        l && e.end >= n && e.end <= s && (i.setEnd(t, e.end - n), (a = !0)),
        (n = s);
    } else if ('BR' === o.tagName)
      l || e.start !== n || (i.setStartBefore(o), (l = !0)),
        l && e.end === n && (i.setEndBefore(o), (a = !0)),
        n++;
    else {
      const t = o;
      let e = t.childNodes.length;
    ...
    return (
      t.forEach((i, s) => {
        ...
        if (e.bgColor && 'string' == typeof e.bgColor) {
          ...
          (t.style.backgroundColor = e.bgColor), t.appendChild(o), (o = t);
        }
        ...
        (c.style.fontFamily = e.fontFamily || r),
          ...
          c.appendChild(o),
          n.appendChild(c),
          s < t.length - 1 && n.appendChild(document.createElement('br'));
      }),
      n
    );
  }
...
class d {
  ...
  hanldeHyperlinkClick(t, e, n, i, s) {
    const o = this.getCommonHyperlinkInRange(t, e, n, i, s);
    this.showHyperlinkInput(o);
  }
  getCommonHyperlinkInRange(t, e, n, i, s) {
    let o = n,
      l = 0;
    i && (l = s.findIndex(t => t.dataId === i));
    const a = s[l].pieces;
    let r = null;
    for (let n of a) {
      const i = o + n.text.length;
      if (i > t && o < e) {
  ...
  showHyperlinkInput(t) {
    const e = document.getElementById(r.HYPERLINK_CONTAINER_ID),
      ...
      s = document.getElementById(r.HYPERLINK_APPLY_BTN_ID),
      o = document.getElementById(r.HYPERLINK_CANCEL_BTN_ID);
    if (e && n && s && o) {
  ...
  applyHyperlink(t, e) {
    this.undoRedoManager.saveUndoSnapshot(),
      this.removeHighlightSelection(),
      s(this.editorView.container, this.savedSelection);
    const [n, i] = o(this.editorView);
    n < i &&
      (e.length > 1
        ? this.document.blocks.forEach(i => {
            if (e.includes(i.dataId)) {
              ...
              let s = n - e;
              this.document.formatAttribute(s, e, 'hyperlink', t);
            }
          })
...
function h(t, n) {
  ...
  if (t instanceof HTMLElement)
    ...
    const n = t.nodeValue || '';
    '' !== n.trim() && s.push(new e(n, Object.assign({}, i)));
  }
  return s;
}
const u = {
...
class g {
  ...
  parseElement(t) {
    ...
    'UL' === t.tagName
      ? (s = 'ul')
      : 'OL' === t.tagName &&
        ((s = 'ol'), (o = parseInt(t.getAttribute('start') || '1', 10)));
    let l = [];
    return (
      s ? this.parseListItems(t, l) : this.parseParagraphText(t, l),
      Object.assign(
        Object.assign(
          Object.assign(
...
class p {
  ...
  insertImageAtPosition(t, n, i) {
    ...
    const s = `data-id-${Date.now()}-${1e3 * Math.random()}`,
      o = `data-id-${Date.now()}-${1e3 * Math.random()}`,
  ...
  addStyleToImage(t) {
    if (!this.isCrossIconVisible) {
      ...
      (s.className = r.IMAGE_CROSS_CLASS),
        (s.innerHTML = 'x'),
...
class f {
  constructor(t, i) {
    ...
    const { mainEditorId: v, toolbarId: E } = (function (t, e) {
      ...
      e.features.forEach(t => {
        if ('fontFamily' === t) {
          ...
          const t = g(r.FONT_SIZE_SELECT_ID, o);
          a.appendChild(t);
        } else if ('fontColor' === t) {
    ...
    (this.document = new n()),
      ...
      null === (s = document.getElementById('fontColor')) ||
        void 0 === s ||
        s.addEventListener('click', t => {
          const e = document.getElementById('fontColorPicker');
                ...
                this.document.dataIds.length > 1
                  ? this.document.blocks.forEach(t => {
                      if (this.document.dataIds.includes(t.dataId)) {
                        ...
                        let s = n - i;
                        this.document.applyFontColor(s, i, e);
                      }
                    })
      ...
      null === (o = document.getElementById('bgColor')) ||
        void 0 === o ||
                ...
                this.document.dataIds.length > 1
                  ? this.document.blocks.forEach(t => {
                      if (this.document.dataIds.includes(t.dataId)) {
                        ...
                        let s = n - i;
                        this.document.applyBgColor(s, i, e);
                      }
                    })
                  : (this.debounceTimer && clearTimeout(this.debounceTimer),
                    (this.debounceTimer = setTimeout(() => {
          ...
          this.document.dataIds.length > 1
            ? this.document.blocks.forEach(t => {
                if (this.document.dataIds.includes(t.dataId)) {
                  ...
                  let s = n - i;
                  this.document.setFontFamily(s, i, e);
                }
              })
          ...
          this.document.dataIds.length > 1
            ? this.document.blocks.forEach(t => {
                if (this.document.dataIds.includes(t.dataId)) {
                  ...
                  let s = n - i;
                  this.document.setFontSize(s, i, e);
                }
              })
      ...
      this.editorContainer.addEventListener('paste', t => {
        ...
        const s =
            null === (n = t.clipboardData) || void 0 === n
              ? void 0
              : n.getData('text/html'),
          [o, l] = this.getSelectionRange();
        l > o && this.document.deleteRange(o, l);
        let a = [];
        if (s) a = c(s);
        else {
          const n =
  ...
  handleSelectionChange() {
    ...
    this.imageHandler.currentCursorLocation = e;
    const n = window.getSelection();
    if (!n || 0 === n.rangeCount) return;
    n && !0 === n.isCollapsed && (this.document.dataIds = []);
    const i = n.getRangeAt(0),
      s =
        (null === (t = i.startContainer.parentElement) || void 0 === t
          ? void 0
          : t.closest('[data-id]')) || i.startContainer;
    s instanceof HTMLElement &&
      (this.document.selectedBlockId =
        s.getAttribute('data-id') ||
        (i.startContainer instanceof HTMLElement
          ? i.startContainer.getAttribute('data-id')
          : null)),
      this.syncCurrentAttributesWithCursor();
  }
  handleKeydown(t) {
    var n;
    const [i, s] = this.getSelectionRange();
    ...
    if ('Enter' === t.key) {
      ...
      if (l && 'image' === l.type)
        this.document.blocks.splice(s + 1, 0, {
          ...
          this.document.emit('documentChanged', this),
          console.log('image - vicky', n),
          this.imageHandler.setCursorPostion(1, n);
      else if (
        !l ||
          ...
          if (l.length > 0) {
            ...
            '' !== r[0] || void 0 !== r[1]
              ...
              (a = this.addBlockAfter(
                this.document.blocks,
                this.getCurrentCursorBlock().toString(),
                { dataId: n, class: 'paragraph-block', pieces: d, type: 'text' }
              )),
              (o = i + l.length - 1);
          } else
            a = this.addBlockAfter(
        ...
        if (
          ...
          for (let t = s + 2; t < this.document.blocks.length; t++) {
            ...
            if ('li' !== e.listType || e.parentId !== i) break;
            e.listStart += 1;
          }
      }
      this.syncCurrentAttributesWithCursor(),
        this.editorView.render(),
        this.setCursorPosition(o + 1, n),
        o > i &&
          this.document.deleteRange(
            i,
            o,
      ...
      if (
        ...
        this.document.dataIds.length >= 1 &&
          ...
          (this.document.deleteBlocks(), this.setCursorPosition(i + 1)),
        i === s && i > 0)
      ) {
        const t = this.document.blocks.findIndex(
            t => t.dataId === this.document.selectedBlockId
          ),
          e = 0 === i - this.document.currentOffset && t > 0;
        this.document.deleteRange(
          i - 1,
          i,
          this.document.selectedBlockId,
        ...
        const n = this.document.blocks.findIndex(
          t => t.dataId === this.document.selectedBlockId
        );
        console.log(n, 'index lntgerr');
        if (
          null ===
        ...
        s > i &&
          ...
          this.setCursorPosition(i + 1));
    } else if (1 !== t.key.length || t.ctrlKey || t.metaKey || t.altKey) {
      if ('Delete' === t.key) {
        if (
          (t.preventDefault(),
          this.document.dataIds.length >= 1 &&
          ...
          const t = this.document.dataIds[0],
            n = this.document.blocks.findIndex(e => e.dataId === t);
          ...
          if (0 === this.document.blocks.length) {
            ...
            this.document.blocks.push({
              ...
              (s = 0),
              this.editorView.render();
          } else if (n < this.document.blocks.length)
            (i = this.document.blocks[n].dataId), (s = 0);
          else {
            const t = this.document.blocks[this.document.blocks.length - 1];
            (i = t.dataId),
              (s = t.pieces.reduce((t, e) => t + e.text.length, 0));
          }
          return void this.setCursorPosition(s, i);
        }
        if (s > i) {
          const t = Math.min(this.document.currentOffset, i);
          return (
            this.document.deleteRange(i, s, this.document.selectedBlockId, t),
            void this.setCursorPosition(i)
          );
        }
        const o = this.document.blocks.findIndex(
          t => t.dataId === this.document.selectedBlockId
        );
        if (-1 === o) return;
        const l = this.document.blocks[o],
          a = l.pieces.reduce((t, e) => t + e.text.length, 0);
        if (i - this.document.currentOffset < a) {
          const t = Math.min(this.document.currentOffset, i);
          return (
            this.document.deleteRange(
              i,
        ...
        const r = this.document.blocks[o + 1];
        if (!r) return;
        if ('image' === r.type)
          return (
            this.undoRedoManager.saveUndoSnapshot(),
            this.document.blocks.splice(o + 1, 1),
            this.document.emit('documentChanged', this.document),
            void this.setCursorPosition(i, l.dataId)
          );
        if ('text' === r.type) {
          this.undoRedoManager.saveUndoSnapshot();
          const t = [...l.pieces, ...r.pieces];
          return (
            (l.pieces = this.document.mergePieces(t)),
            this.document.blocks.splice(o + 1, 1),
            this.document.emit('documentChanged', this.document),
            void this.setCursorPosition(i, l.dataId)
          );
  ...
  extractTextFromDataId(t) {
    ...
    const s = this.document.blocks.filter(e => {
        if (e.dataId === t) return e;
      }),
      o = document.querySelector(`[data-id="${t}"]`),
    ...
    const d = i,
      ...
      h = d.slice(c),
      u = d.slice(0, c);
    return (o.textContent = u), { remainingText: h, piece: a };
  }
  ...
  setCursorPosition(t, e = '') {
    ...
    const i = document.createRange();
    let s = 0;
    const o = [this.editorView.container];
    let l;
    for (; (l = o.pop()); )
      if (3 === l.nodeType) {
        const e = l,
