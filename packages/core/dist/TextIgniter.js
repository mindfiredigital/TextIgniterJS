...
export class TextIgniter {
    constructor(editorId, config) {
        ...
        this.editorContainer.addEventListener('keydown', (e) => { this.syncCurrentAttributesWithCursor(); this.handleKeydown(e); });
    ...
    handleSelectionChange() {
        ...
        const range = selection.getRangeAt(0);
        const parentBlock = ((_a = range.startContainer.parentElement) === null || _a === void 0 ? void 0 : _a.closest('[data-id]')) || range.startContainer;
    ...
    getCurrentCursorBlock() {
        ...
        const elementWithId = (container.nodeType === Node.TEXT_NODE
            ...
            : container);
        const dataIdElement = elementWithId === null || elementWithId === void 0 ? void 0 : elementWithId.closest('[data-id]'); // Find closest ancestor with `data-id`
